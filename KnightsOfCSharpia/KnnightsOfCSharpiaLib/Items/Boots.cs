namespace KnightsOfCSharpiaLib.Items
{
    ...
    public class Boots : Item
    {
        ...
        /// <summary>
        /// Creates Boots with randomly generated properties and values, which are passed in as a parameter.
        ...
        /// </param> 
        internal Boots(string name, ItemRarity rarity, List<KeyValuePair<PropertyInfo, int>> propertiesAndValues)
            : this(name, rarity)
        {
