namespace KnightsOfCSharpiaLib.Items
{
    ...
    public class Hood : Item
    {
        ...
        /// <summary>
        /// Creates a Hood with randomly generated properties and values, which are passed in as a parameter.
        ...
        /// </param> 
        public Hood(string name, ItemRarity rarity, List<KeyValuePair<PropertyInfo, uint>> propertiesAndValues)
            : this(name, rarity)
        {
