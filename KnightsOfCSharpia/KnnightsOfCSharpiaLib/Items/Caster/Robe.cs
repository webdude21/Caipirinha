namespace KnightsOfCSharpiaLib.Items
{
    ...
    public class Robe : Item
    {
        ...
        [JsonConstructor]
        public Robe(string name, ItemRarity rarity)
        ...
        /// <summary>
        /// Creates a Robe with randomly generated properties and values, which are passed in as a parameter.
        ...
        /// </param> 
        public Robe(string name, ItemRarity rarity, List<KeyValuePair<PropertyInfo, uint>> propertiesAndValues)
            :this(name, rarity)
        {
